            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        ...
                        <span class="light-logo" style="font-size: 30px; font-weight:700; color:white; vertical-align: middle;">Sass Admin</span>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="req/login.php" method="POST">
